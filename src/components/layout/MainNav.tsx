...
export function MainNav({ activeView, onViewChange }: MainNavProps) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass-panel border-t border-border/30 md:relative md:bottom-auto md:border-t-0 md:border-b md:border-border/30">
